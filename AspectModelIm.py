...
class CAspectModel:
    def __init__(self):
        ...
        self.user_hidden_item_prob = None
    ...
    def initParameters(self, Data, hidden_num):
        ...
        self.hidden_prob = np.random.random(hidden_num)
        normalizeVec(self.hidden_prob)
        self.user_hidden_item_prob = np.zeros([users_num, items_num, hidden_num], dtype=np.float) #Q(z,u,y)
